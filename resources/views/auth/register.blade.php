...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register your full address to receive the best coffee!! ;) ') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" placeholder="(XX) XXXX-XXXX " type="text" class="form-control{{ $errors->has('Phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input type="checkbox" class="form-check-input" id="terms" name="terms" required autofocus>
                                @if ($errors->has('terms'))
                                    <span class="invalid-feedback" role="alert">
